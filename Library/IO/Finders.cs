...
namespace XQuinn.IO.Finders
{
    ...
    {
        public static readonly string Path = System.IO.Path.Combine(CodeLabFinder.Path, "VietnamWarModLab")//Directory.EnumerateDirectories(CodeLabFinder.Path, "VietnamWarModLab", SearchOption.TopDirectoryOnly).FirstOrDefault() 
    ...
    {
        public static readonly string Path = System.IO.Path.Combine(KnownFolders.Desktop, "C#Lab") //Directory.EnumerateDirectories(KnownFolders.Desktop, "C#Lab", SearchOption.TopDirectoryOnly).FirstOrDefault()
